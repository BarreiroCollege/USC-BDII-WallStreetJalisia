...
insert into usuario (identificador, clave, direccion, cp, localidad, telefono, saldo, saldo_bloqueado, activo, baja, otp, sociedad, lider_de)
...
insert into usuario (identificador, clave, direccion, cp, localidad, telefono, saldo, saldo_bloqueado, activo, baja, otp, sociedad, lider_de)
values ('libjaim', 'sha1:64000:18:0krmbeQFU13IagFzaqTMnsU+gBUchFH6:GyWDhmCGNAmArXe7PyP9uZlW', 'Calle Baja, 14', '15701', 'Santiago de Compostela', 648572333, 200.0, true, false,'P52ZHRYQK2VA7ZARQGJ34HBUKPZ5KRVW','urrs', false );
insert into empresa (usuario, cif, nombre)
values ('libjaim', 'P-19752648', 'Libros Jaime');
insert into usuario (identificador, clave, direccion, cp, localidad, telefono, saldo, saldo_bloqueado, activo, baja, otp, sociedad, lider_de)
values ('zapPaco', 'sha1:64000:18:0krmbeQFU13IagFzaqTMnsU+gBUchFH6:GyWDhmCGNAmArXe7PyP9uZlW', 'Calle Alta, 41', '17501', 'Santiago de Compostela', 648572333, 200.0, true, false,'EXI2KZIUCCGMR4EGYXEJJEXDN2GNMIUD','ubicorp', true );
insert into empresa (usuario, cif, nombre)
...
insert into pago_usuario (usuario, pago_fecha, pago_empresa, num_participaciones)
values ('pepe', '2021-01-06 13:19:42', 'teceric', 20);
