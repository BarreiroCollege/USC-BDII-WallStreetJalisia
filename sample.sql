...
values ('manuel', 'sha1:64000:18:gQh8DgIBEwFWNANA16hiluLqCTYsMIwG:p+2PGzw91P3g/ysi6XBLc6NJ', 'Calle del olmo, 27',
        '28012', 'Madrid', 617483290, 529.0, 0.0, NOW(), null, 'H3MSFZO7X7A3OKZOA4OYOJXBN3C4ED5Q', 'aaI', true);
...
values ('marcos', 'sha1:64000:18:xN6xzXXuxSzqbrpnHJIqv1FZWdTLYRCc:5ngoCRSKBJwbQ8nSm4jVwZip', 'Calle Abedul, 12',
        '28036', 'Madrid', 628714222, 1067.0, 0.0, NOW(), null, 'QZ3YM24E7KHVUIQTFNZIKZ2FIKNT6FTW', 'invemena', false);
insert into inversor (usuario, dni, nombre, apellidos)
...
values ('sara', 'sha1:64000:18:7Vjvu9VX0GGKPBVgQ/LuhGiKAw8dtY6p:7qV7nXM1IIn5oA49kmN0x/Wt', 'Calle del Palomar, 31',
        '15701', 'Santiago de Compostela', 615237989, 513.15, 0.0, NOW(), null, 'OJEAZFGLPKOAOHTM5ILNRTTQOL6DS6YP',
        'urrs', false);
insert into inversor (usuario, dni, nombre, apellidos)
...
values ('eva', 'sha1:64000:18:fRyIy2KpkOhXIkFl9+OCu6BPq32xY2+Y:d5j3M7amOsYqisxLDk6VbSL3', 'Calle del mar, 78', '15701',
        'Santiago de Compostela', 678910344, 1485.30, 0.0, NOW(), null, 'SEBID4GBR4WBHL5TMS2KYQRZ735UECJS', 'hampa',
        true);
insert into inversor (usuario, dni, nombre, apellidos)
...
values ('pepe', 'sha1:64000:18:fRyIy2KpkOhXIkFl9+OCu6BPq32xY2+Y:d5j3M7amOsYqisxLDk6VbSL3', 'Calle del mar, 78', '15701',
        'Santiago de Compostela', 678910344, 1485.30, 0.0, NOW(), null, 'U4NREHH3F4LJONAIBGOD3YT66CHVZFKR', 'urrs',
        true);
insert into inversor (usuario, dni, nombre, apellidos)
...
values ('teceric', 'sha1:64000:18:0WoocFp8pqjWuMP/72KFmGE62xjlBsP6:MEB75nM5A3WfLS10Bj5DTu6A', 'Calle 10 de Marzo',
        '36210', 'Vigo', 986331724, 7012.0, 0.0, NOW(), null, 'GWI7QDYNDQZQ3BZU7I6WTGPCIK5S5Q75', 'aaI', false);
...
values ('garcables', 'sha1:64000:18:0cUa4PNwAG+HJvz3JD5Zg4Ru08Bo0J/Y:djo94B5Vc1r5gPasgWM6B88K',
        'Avenida Ramón y Cajal, 79', '28016', 'Madrid', 677100888, 2410.0, 0.0, NOW(), null,
...
values ('fruLuis', 'sha1:64000:18:lNI/FgENoXpD23en+RSumH2ZkdBeC+ga:Xb5ptBI+UaD7VdLBiG0GU25E', 'Camino sombrío, 14',
        '39212', 'Fontecha', 147025316, 1000.0, 0.0, NOW(), null, 'VTFQD7DQE2ZGTCIDKNBFZ3MNKWKE5NYO', null, false);
insert into empresa (usuario, cif, nombre)
...
values ('libjaim', 'sha1:64000:18:0krmbeQFU13IagFzaqTMnsU+gBUchFH6:GyWDhmCGNAmArXe7PyP9uZlW', 'Calle Baja, 14', '15701',
        'Santiago de Compostela', 648572333, 200.0, 0.0, NOW(), null, 'P52ZHRYQK2VA7ZARQGJ34HBUKPZ5KRVW', 'urrs',
        false);
insert into empresa (usuario, cif, nombre)
...
values ('zapPaco', 'sha1:64000:18:0krmbeQFU13IagFzaqTMnsU+gBUchFH6:GyWDhmCGNAmArXe7PyP9uZlW', 'Calle Alta, 41', '17501',
        'Santiago de Compostela', 648572333, 200.0, 0.0, NOW(), null, 'EXI2KZIUCCGMR4EGYXEJJEXDN2GNMIUD', 'ubicorp',
        true);
insert into empresa (usuario, cif, nombre)
